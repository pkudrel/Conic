...
namespace NamedPipeWrapper
{
    ...
    {
        /// <summary>
        /// Constructs a new <c>NamedPipeClient</c> to connect to the <see cref="NamedPipeNamedPipeServer{TReadWrite}" /> specified
        ...
        where TWrite : class
    {
        ...
        /// <summary>
        /// Constructs a new <c>NamedPipeClient</c> to connect to the <see cref="NamedPipeServer{TRead, TWrite}" /> specified by
    ...
    internal static class PipeClientFactory
    {
        ...
        public static bool NamedPipeExists(string pipeName)
        {
            try
            {
                var exists = WaitNamedPipe(pipeName, -1);
                if (!exists)
                {
